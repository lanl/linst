...
solver.solve(alpha=np.linspace(0.4, 1.2, 100), beta=0., omega_guess=0.0+0.2837*1j)
#solver.solve(alpha=np.linspace(0.6, 0.600001, 2), beta=0., omega_guess=0.0+0.3525*1j) 
