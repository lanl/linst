...
class Mapping:
    ...
    def map_shear_layer(self, sinf, yi, l, DM, bsfl_ref, boussinesq): # passing yinf (sinf), Gauss-Lobatto points (yi), l and differentiation matrices on [1,-1]
        """
        ...
        if ( boussinesq == -2 ): # dimensional solver
